...
@media screen and (max-width: 300px) {
 ...
 <li><a href="logvc.jsp">login</a></li>
   ...
   <li><a href="homevc.jsp">logOut</a></li>     
          ...
          <h6 style="text-align: center;font-size: 30px;color:#333333;text-decoration: underline">Ask questions here:-</h6>
                   <label style="font-size:30px;"><b>For Questions click on question</b></label><br>
          <a href="qs.jsp" style="font-size: 25px">Question</a>
          <br>
          <br>
          ...
          <form action="qus.jsp" method="post" style="background-color: green">
...
<label style="font-size: 20px"><b>Enter Question</b></label><br>
<br>
<textarea name="qus" rows="10" cols="60" placeholder="Enter Qustion"></textarea><br><br>
