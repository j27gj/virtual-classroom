 ...
 <li><a href="logvc.jsp">login</a></li>
   ...
   <li><input type="submit" onclick="location.href='http://google.com'; target='_blank;'" name="search_button" id="search_button" value="Go.." ></li>
         <li><a href="homevc.jsp">logOut</a></li>     
          ...
          <h6 style="text-align: center;font-size: 30px;color:#333333;text-decoration: underline">Question and Answers-</h6>
          <label style="font-size:30px;"><b>For Questions click on question</b></label><br>
          <a href="qs.jsp" style="font-size: 25px">Questions</a>
          <br><br>
                  <label style="font-size:30px;"><b>For Answers click on Answer</b></label><br>
          <a href="as.jsp" style="font-size: 25px">Answer</a>
          <br>
          <br>
          <form action="ans.jsp" method="post" style="background-color: green">
              <label style="font-size: 20px"><b>Subject</b></label><br><br>
...
<option value=".net">.NET</option></select>
              <br><br>
 <label style="font-size: 20px"><b>Question no.</b></label><br><br>
 <input type="text" name="no"><br>
<label style="font-size: 20px"><b>Enter Answer</b></label><br>
<br>
<textarea name="ans" rows="10" cols="60" placeholder="Enter Answer"></textarea><br><br>
