...
@media screen and (max-width: 300px) {
 ...
 <li><a href="logvc.jsp">login</a></li>
   ...
   <li><input type="submit" onclick="location.href='http://google.com'; target='_blank;'" name="search_button" id="search_button" value="Go.." ></li>
          ...
          <h6 style="text-align: center;font-size: 30px;color:#333333;text-decoration: underline">Answers-</h6>
       
          <br>
          <br>
          <form action="answer.jsp" method="post" style="background-color: green">
