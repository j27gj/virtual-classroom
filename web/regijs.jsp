...
@media screen and (max-width: 300px) {
 ...
 <li><a href="logvc.jsp">login</a></li>
   ...
   <li><input type="submit" onclick="location.href='http://google.com'; target='_blank;'" name="search_button" id="search_button" value="Go.." ></li>
          ...
          <h2 style="text-align:center;">Student Signup Form</h2>

<form method="post" action="stu.jsp" style="border:1px solid #ccc;margin-left: 250px;margin-right: 250px;background-color: greenyellow">
  <div class="container">
